 ...
 */
final class Version20220609104854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ads (id INT AUTO_INCREMENT NOT NULL, ad_category_id INT NOT NULL, is_visible INT NOT NULL, username VARCHAR(20) NOT NULL, email VARCHAR(64) NOT NULL, phone VARCHAR(9) NOT NULL, title VARCHAR(64) NOT NULL, text VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7EC9F620390D4E23 (ad_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
